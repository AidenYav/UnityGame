...
=== Scene1_0 ===
    ...
    MAYOR: Sadly, there is a price, but I believe in you. It’ll be <color=green>{tavernCost}</color>. She hoped she would get well enough to make something of a tavern of it, but she never did…
