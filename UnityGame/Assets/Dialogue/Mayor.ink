...
=== Scene1 ===
    MAYOR: Oh! You must be <color=orange>[MC Name]</color>, welcome to Fortune Falls! How was the trip?
        *Good! #Reputation:10
            MAYOR: Jolly!
    ...
    * Of course! #Reputation: 5
    MAYOR: Splendid! What will you name your tavern <color=orange>[MC NAME]</color>?
